...
namespace csci5570 {
    namespace {
        ...
        TEST_F(TestWorkerSpec, InsertWorkerIdThreadId) {
            ...
            worker_spec.InsertWorkerIdThreadId(3, SimpleIdMapper::kMaxThreadsPerNode +
                                                  SimpleIdMapper::kMaxBgThreadsPerNode);
            worker_spec.InsertWorkerIdThreadId(4, SimpleIdMapper::kMaxThreadsPerNode +
                                                  SimpleIdMapper::kMaxBgThreadsPerNode + 1);
